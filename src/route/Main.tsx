...
import clientLogo from "../assets/images/your-logo-here.png";
        ...
        <main className={classes.content}>
          <Container maxWidth="lg" className={classes.container}>
            <Switch>
              ...
              <Route path={`${match.path}/tabulasi`}>
                <Tabulasi />
              </Route>
              <Route path={`${match.path}/detail/:name/:type`}>
                <DetailChart />
              </Route>
              <Route path={`${match.path}/detail-cabang`}>
                <Evidence />
              </Route>
            </Switch>
          </Container>
